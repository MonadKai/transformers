...
class FunasrNanoFeatureExtractor(FeatureExtractionMixin):
    def __init__(
        self,
        fs: int = 16000,
        window: str = "hamming",
        ...
        **kwargs,
        ...
        for i in range(batch_size):
            ...
            if self.lfr_m != 1 or self.lfr_n != 1:
                mat = apply_lfr(mat, self.lfr_m, self.lfr_n)  # [ceil(T / lfr_n), n_mels * lfr_m]
            feat_length = mat.size(0)  # [ceil(T / lfr_n)]
            feats.append(mat)
