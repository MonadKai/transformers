...
class FunasrNanoProcessor(ProcessorMixin):
    r"""
    Constructs a FunasrNano processor which wraps a FunasrNano feature extractor and a Qwen2TokenizerFast tokenizer into a single processor.

    [`FunasrNanoProcessor`] offers all the functionalities of [`FunasrNanoFeatureExtractor`] and [`Qwen2TokenizerFast`]. See the
    [`~FunasrNanoProcessor.__call__`] and [`~FunasrNanoProcessor.decode`] for more information.

    Args:
        feature_extractor ([`FunasrNanoFeatureExtractor`], *optional*):
        ...
        chat_template (`Optional[str]`, *optional*):
                ...
                is used.
        audio_token (`str`, *optional*, defaults to `"!"`):
            The token to use for audio tokens.
        audio_bos_token (`str`, *optional*, defaults to `"<|startofspeech|>"`):
            The token to use for audio bos tokens.
        audio_eos_token (`str`, *optional*, defaults to `"<|endofspeech|>"`):
