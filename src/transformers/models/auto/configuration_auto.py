...
CONFIG_MAPPING_NAMES = OrderedDict[str, str](
    [
        ...
        ("parrot_audio", "ParrotAudioConfig"),
        ("parrot_audio_encoder", "ParrotAudioEncoderConfig"),
        ("parrot2_audio", "Parrot2AudioConfig"),
        ("parrot2_audio_encoder", "Parrot2AudioEncoderConfig"),
        ("parrot2_audio_moe", "Parrot2AudioMoeConfig"),
        ("parrot2_audio_moe_encoder", "Parrot2AudioMoeEncoderConfig"),
        ("parrot_sensevoice", "ParrotSenseVoiceConfig"),
...
MODEL_NAMES_MAPPING = OrderedDict[str, str](
    [
        ...
        ("owlvit", "OWL-ViT"),
        ("paligemma", "PaliGemma"),
        ("parrot_audio", "ParrotAudio"),
        ("parrot_audio_encoder", "ParrotAudioEncoder"),
        ("parrot2_audio", "Parrot2Audio"),
        ("parrot2_audio_encoder", "Parrot2AudioEncoder"),
        ("parrot2_audio_moe", "Parrot2AudioMoe"),
        ("parrot2_audio_moe_encoder", "Parrot2AudioMoeEncoder"),
        ("parrot_sensevoice", "ParrotSenseVoiceEncoder"),
...
SPECIAL_MODEL_TYPE_TO_MODULE_NAME = OrderedDict[str, str](
    [
        ...
        ("parrot_audio_encoder", "parrot_audio"),
        ("parrot2_audio_encoder", "parrot2_audio"),
        ("parrot2_audio_moe_encoder", "parrot2_audio_moe"),
        ("parrot_sensevoice", "parrot_sensevoice"),
