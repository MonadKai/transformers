...
from .modeling_dots_ocr_vision import DotsVisionTransformer
    ...
    def prepare_inputs_embeds(
        ...
        if pixel_values is not None:
            ...
            if grid_thw.shape[0] > DOTS_VLM_MAX_IMAGES:
                print(f"Num image exceeded: {grid_thw.shape[0]} > {DOTS_VLM_MAX_IMAGES}, which may cause FSDP hang")
            ...
            assert vision_embeddings.size(0) == new_img_mask.sum(), (
