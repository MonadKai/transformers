...
class Parrot2AudioProcessor(ProcessorMixin):
    r"""
    Constructs a Parrot2Audio processor which wraps a Parrot2Audio feature extractor and a Qwen2TokenizerFast tokenizer into a single processor.

    [`Parrot2AudioProcessor`] offers all the functionalities of [`Parrot2AudioFeatureExtractor`] and [`Qwen2TokenizerFast`]. See the
    [`~Parrot2AudioProcessor.__call__`] and [`~Parrot2AudioProcessor.decode`] for more information.
    ...
    feature_extractor_class = "Parrot2AudioFeatureExtractor"
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Parrot2AudioFeatureExtractor's [`~Parrot2AudioFeatureExtractor.__call__`] if `audios` is not `None`. Please refer to the doctsring
