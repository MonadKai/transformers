...
"""
Processor class for ParrotAudio.
"""
...
class ParrotAudioProcessor(ProcessorMixin):
    r"""
    Constructs a ParrotAudio processor which wraps a ParrotAudio feature extractor and a Qwen2TokenizerFast tokenizer into a single processor.

    [`ParrotAudioProcessor`] offers all the functionalities of [`ParrotAudioFeatureExtractor`] and [`Qwen2TokenizerFast`]. See the
    [`~ParrotAudioProcessor.__call__`] and [`~ParrotAudioProcessor.decode`] for more information.

    Args:
        feature_extractor ([`SenseVoiceExtractor`], *optional*):
    ...
    # TODO: optimize this to direct use ParrotSenseVoiceFeatureExtractor
    feature_extractor_class = "ParrotAudioFeatureExtractor"
    ...
    def __call__(
        ...
        **kwargs,
        ...
        ParrotAudioFeatureExtractor's [`~ParrotAudioFeatureExtractor.__call__`] if `audios` is not `None`. Please refer to the doctsring
